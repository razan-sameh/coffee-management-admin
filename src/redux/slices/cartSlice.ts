...
export const placeOrder = createAsyncThunk<
  void, // return type
  Omit<typOrder, "id" | "platform" | "date" | "status" | "delivery" | "total">,
  { rejectValue: string }
>("cart/placeOrder", async (orderData, { dispatch, rejectWithValue }) => {
  try {
...
export const { setCart, setProducts, removeFromCart, clearCart } =
  cartSlice.actions;
