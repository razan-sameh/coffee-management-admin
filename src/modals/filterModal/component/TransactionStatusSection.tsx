...
export const TransactionStatusSection: React.FC<Props> = ({
  tempFilters,
  onChange,
}) => {
  const renderChips = (
  ...
  return (
    <Grid size={12} sx={{ md: 6 }}>
      ...
      {renderChips("Order Status", Object.values(enmDateRangeFilter), "status")}
      {renderChips(
        "Order Payment",
        Object.values(enmPaymentMethod),
        "paymentMethod"
      )}
